      ...
      style={
        {
          ...
          "--width": `${width}`,
          "--aspect-ratio": `${ar}`,
          // Cyan color, slightly transparent
          "--background": `linear-gradient(180deg, oklch(0.7 0.13 200) 0%, oklch(0.7 0.13 200 / 0.0) 100%)`,
...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  beamDelayMin = 0,
  beamDuration = 3,
  // gridColor: roxo escuro
  gridColor = "oklch(.129 .042 264.695)",
  ...props
}) => {
  ...
  return (
    <div
      ...
      style={{ background: "oklch(.129 .042 264.695)" }}
      {...props}
    >
      <div
        style={
